...
| :--- | :---: | :--- |
| <strong>(주)Geeksloft</strong> <br/>인턴 | 22.09.01<br>~현재 |<em>*개발팀 프론트엔드 파트 수습연구원</em> <br/><small> 메타버스 유아쇼핑몰 Back Office 개발 중 <br/>자사 홈페이지 리뉴얼 개발 지원<br/> 개인화 질병 예측 프로젝트 개발완료</small>|
