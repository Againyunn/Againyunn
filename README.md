...
| <strong>(유한회사) miso</strong> <br>계약직 근무 | 20.09.11 <br>~20.10.31 | <em>*Moving부서(미소 이사서비스) CRM 주말팀</em><br>고객관리, 아웃바운드 업무(고객인입건 처리, 이사견적산출 및 이사 파트너 매칭안내 업무), 마케팅성과 측정 및 보고 |
...
|---|---|---|
| <strong>AI Education Institute</strong> <br>SW 교육 조교 | 22.02.07<br>~22.02.18 | 한국외국어대학교 신입생 학기 전 SW 교육 조교<br>groom 시스템 활용하여, 파이썬 프로그래밍 실습 & 과제 질의응답 진행<br>(Python Programming Education Assistant) |
